...
class Test () :
	...
	def start (self) :
		...
		self.results.append(self.testAppProgrammingLanguage1())
		self.results.append(self.testAppHistory1())
	...
	def testAppHistory1 (self) :
		a = App_History()
		a.UTEID = "blah"
		a.course_id = "Russian"
		print "testHistory1 =",Validation.AppHistoryDataValidator(a)
